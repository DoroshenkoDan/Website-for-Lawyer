...
export function PracticeCard({
  ...
  return (
    <Link
      href={href}
      className="group flex h-full flex-col rounded-2xl border border-white/10 bg-linear-[160deg] from-graphite from-0% to-graphite-card to-100% p-7 shadow-[0_1px_3px_rgba(0,0,0,0.12),0_8px_24px_rgba(0,0,0,0.18)] transition-all duration-200 hover:-translate-y-0.5 hover:border-accent/60 hover:shadow-[0_16px_36px_rgba(0,0,0,0.28)] sm:p-9"
    >
